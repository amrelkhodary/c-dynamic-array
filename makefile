...
$(BIN_DIR)/cdyar_darray.o: $(SRC_DIR)/cdyar_darray.c $(HEADER_DIR)/cdyar_darray.h $(HEADER_DIR)/cdyar_structures.h $(HEADER_DIR)/cdyar_error.h $(HEADER_DIR)/cdyar_types.h | $(BIN_DIR)
...
$(BIN_DIR)/cdyar_error.o: $(SRC_DIR)/cdyar_error.c $(HEADER_DIR)/cdyar_error.h | $(BIN_DIR)
	$(CC) $(CFLAGS) $(DEBUG_FLAGS) -c $< -o $@

# Compile main.c
$(MAIN_OBJ): $(SRC_DIR)/main.c $(HEADER_DIR)/cdyar.h $(HEADER_DIR)/cdyar_darray.h $(HEADER_DIR)/cdyar_structures.h $(HEADER_DIR)/cdyar_error.h $(HEADER_DIR)/cdyar_types.h $(HEADER_DIR)/cdyar_arithmetic.h | $(BIN_DIR)
	$(CC) $(CFLAGS) $(DEBUG_FLAGS) -c $< -o $@
